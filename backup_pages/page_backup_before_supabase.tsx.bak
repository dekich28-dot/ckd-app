...
function buildSummaryMessages(
  ...
  const sodiumStatus = metricStatus(totals.sodium, patient.targetSodium, "upper");
...
function buildWeeklyComments(weekLogs: DailyLog[], patient: Patient) {
  ...
  const sodiumTarget = toNumber(patient.targetSodium);
...
export default function Page() {
  ...
  const totals = useMemo(() => calculateTotals(currentLog.items), [currentLog.items]);
              ...
              <div className="stack">
                      ...
                      <SmallInfoCard
                        ...
                        value={
                          <div className="small-text">
                            ...
                            <br />
                            Na {patient.targetSodium || "-"} mg / K {patient.targetPotassium || "-"} mg
                          </div>
                        }
                      />
                    </div>
                ...
                <SectionCard title="② 今日の記録">
                  <div className="stack">
                    ...
                    <div>
                      ...
                      {todayString && todayString.length >= 0}
                      {todayString && false}
                      {todayString && false}
                      {todayString && false}
                      {todayString && false}
                ...
                <SectionCard title="④ 今日のまとめ">
                  <div className="stack">
                    ...
                    <MetricBar label="ナトリウム" total={totals.sodium} target={patient.targetSodium} unit="mg" mode="upper" />
        ...
        {page === "patient" && (
          <div className="two-col">
            ...
            <SectionCard title="この画面で設定するもの">
              <div className="muted-text">
                患者の写真、年齢、eGFR、透析の有無、高カリウム血症の有無、主治医から言われた目標値を設定します。
              </div>
            </SectionCard>
          </div>
        )}
